function cellAnnotator
    ...
    hpactions = uipanel('Tag', 'Actions',...
        'Units', 'pixels',...
        'Position', [padding figHeight-100-padding-topFigOffset figWidth-2*padding 100],...
        'ShadowColor', 'r', ...
        'HighlightColor', 'r',...
        'Background', 'r');
    ...
    hpviewer = uipanel('Tag', 'Viewer', ...
        'Units', 'pixels',...
        'Background', 'r',...
        'Position', [padding, padding, figWidth-2*padding, figHeight-100-padding * 3-topFigOffset]);
