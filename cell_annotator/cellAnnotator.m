function cellAnnotator
    ...
    hpactions = uipanel('Tag', 'Actions',...
        ...
        'ShadowColor', BG_COLOR / 2, ...
        'HighlightColor', BG_COLOR / 2 ,...
...
%     inspect(hfilteredgemeth)
    ...
    function displayUIElements
        ...
        set(hpactions, 'ShadowColor', BG_COLOR / 2)
        set(hpactions, 'HighlightColor', BG_COLOR / 2)
        set(hpactions, 'Background', BG_COLOR / 2)
    end
