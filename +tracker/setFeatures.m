...
params.addKalmanExtrapolationDifference = 0; % Kalman filter tracklet extrapolation to midpoint between tracks...then adds absolute euclidean distance
...
params.kalmanMaxObservations = 15; % Since linear Kalman, don't bother with to much history
